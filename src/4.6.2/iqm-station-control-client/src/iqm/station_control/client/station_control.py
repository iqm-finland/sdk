...
class StationControlClient(StationControlInterface):
        ...
        *,
        ...
        if parsed_url.scheme == "http":
            if parsed_url.hostname in ("localhost", "127.0.0.1"):
                ...
                warnings.warn(
                    f"Insecure HTTP requests to remote hosts are heavily discouraged: '{root_url}'. "
    ...
    def _build_request_kwargs(
        ...
        *,
        ...
        if json_str is not None and octets is not None:
            raise ValueError("json_str and octets are mutually exclusive")
        # Add default headers
