...
from iqm.pulse.gate_implementation import SinglePulseGate
from iqm.pulse.locus_mappings import one_qubit_drive_readout
...
class LRU_F0G1(SinglePulseGate):
    ...
    # locus qubit needs both a drive and a readout resonator to decay into
