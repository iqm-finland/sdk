...
def pack(parameter: Parameter) -> ppb_Parameter:
    ...
    return ppb_Parameter(
        ...
        element_indices=parameter.element_indices,  # type: ignore[arg-type]
        parent_name=parameter.parent_name,  # type: ignore[arg-type]
        parent_label=parameter.parent_label,  # type: ignore[arg-type]
    )
