...
from exa.common.errors.iqm_error import InvalidOperationError, IQMError
...
class _IQMServerClient:
    ...
    def __init__(
        ...
        *,
        ...
        root_url, quantum_computer = _IQMServerClient._normalize_url(iqm_server_url, quantum_computer)
    ...
    def get_quantum_computers(self) -> list[QuantumComputer]:
        """Get the quantum computers of the server."""
        response = self._send_request(requests.get, "quantum-computers")
        return self._deserialize_response(response, ListQuantumComputersResponse).quantum_computers
    ...
    def _submit_job(
        ...
        *,
        ...
        params = _serialize_query_params({"use_timeslot": use_timeslot})
        response = self._send_request(
            requests.post,
    ...
    def _resolve_quantum_computer(self, user_defined_quantum_computer: str | None) -> str:
        """Human-readable alias of the quantum computer this client connects to."""
        quantum_computers = self.get_quantum_computers()
