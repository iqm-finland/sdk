...
from iqm.pulse.locus_mappings import one_component_drive, one_component_virtual_drive
...
class RZ_Virtual(GateImplementation):
    ...
    *If all these assumptions hold* we may implement an RZ gate using a VirtualRZ instruction,
    ...
    locus_mapping_function = one_component_virtual_drive
...
class RZ_ACStarkShift_smoothConstant(  # type: ignore[call-arg]
