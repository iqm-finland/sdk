...
def generate_pauli_dressed_mrb_circuits(
    ...
    Args:
        ...
        optimize_sqg: Whether to optimize single-qubit gates in transpilation. Default is False.
...
class MirrorRBConfiguration(BenchmarkConfigurationBase):
    ...
    Attributes:
        ...
        optimize_sqg: Whether to optimize single-qubit gates in transpilation.
