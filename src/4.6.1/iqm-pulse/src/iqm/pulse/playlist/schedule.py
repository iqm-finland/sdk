...
class Schedule:
    ...
    def front_pad(self, to_duration: int) -> Schedule:
        """Modify the schedule in place by front-padding it with :class:`.Wait` instructions.
    ...
    def front_pad_in_seconds(self, to_duration: float, channel_properties: dict[str, ChannelProperties]) -> Schedule:
        ...
        Args:
            to_duration: Duration of the resulting schedule, in seconds.
            channel_properties: Station channel properties.
