...
from iqm.pulse.locus_mappings import one_component_drive
...
class PrxGateImplementation(GateImplementation):
    ...
    locus_mapping_function = one_component_drive
...
class PRX_CustomWaveforms(PRX_SinglePulse_GateImplementation, CustomIQWaveforms):
    ...
    root_parameters: dict[str, Parameter | Setting] = {
        ...
        "modulation_frequency": Setting(Parameter("", "modulation frequency of the waveforms", "Hz"), 0.0),
    }
    ...
    def _get_pulse(  # type: ignore[override]
        ...
        **rest_of_calibration_data,
        ...
        # Unit tests break without the default value of 0.0 in `pop`, though experiments do not need it. This is because
        # the tests use the raw gate calibration data from an experiment.yml, and the default values from root
        # parameters are not applied.
        modulation_frequency = rest_of_calibration_data.pop("modulation_frequency", 0.0)
        ...
        normalized_modulation_frequency = modulation_frequency / n_samples if n_samples > 0 else 0.0
        return IQPulse(
            n_samples,
            wave_i=wave_i,
            wave_q=wave_q,
            ...
            phase=0,
            phase_increment=0,
            modulation_frequency=normalized_modulation_frequency,
        )
...
class ABC_Constant_smooth(PrxGateImplementation):
    ...
    def _main_pulse(
        ...
        **kwargs,
        ...
        """Return the main part pulse.

        Waveform is the same for both I and Q channels.
        """
