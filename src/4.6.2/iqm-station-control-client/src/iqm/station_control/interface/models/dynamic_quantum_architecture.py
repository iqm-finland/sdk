        ...
        if isinstance(value, dict):
            for k, v in value.items():
                ...
                # them back into tuples.
                    ...
                    raise ValidationError("'override_default_implementation' keys must be strings or tuples.")
            return new_value
        raise ValidationError("'override_default_implementation' must be a dict.")
