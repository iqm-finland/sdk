...
if TYPE_CHECKING:
    from iqm.qiskit_iqm.iqm_provider import IQMBackend as qiskit_IQMBackend
...
class IQMJob(JobV1):
    ...
    def __init__(self, backend: qiskit_IQMBackend, job: CircuitJob, **kwargs):
    ...
    def submit(self) -> None:
        ...
        raise NotImplementedError(
            ...
            "IQMBackend.run, the submission will happen under the hood. The job instance that you get is only for "
    ...
    def result(self, *, timeout: float = DEFAULT_TIMEOUT_SECONDS, cancel_after_timeout: bool = False) -> Result:
        ...
        Raises:
            RequestTimeoutError: Waiting for results exceeded timeout.
