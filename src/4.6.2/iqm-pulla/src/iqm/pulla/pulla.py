...
class PullaJob(IQMServerClientJob):
    ...
    @overload
    def result(self, compiler: Compiler) -> Any | None: ...

    @overload
    def result(self) -> CircuitExecutionResults | None: ...

    def result(self, compiler: Compiler | None = None) -> CircuitExecutionResults | Any | None:
        ...
        if not self._result:
            ...
            run_data = RunData(
                ...
                sweep_data=SweepData(
                    ...
                    modified_timestamp=datetime.now(UTC),
                    begin_timestamp=datetime.now(UTC),
